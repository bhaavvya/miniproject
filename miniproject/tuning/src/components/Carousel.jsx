...
<div className="carousel-inner">
  ...
  <img src="https://img.wynk.in/unsafe/880x307/filters:no_upscale():strip_exif():format(webp)/https://s3.ap-south-1.amazonaws.com/discovery-prod-arsenal/arsenal/artworks/651badc16ed4985d961a578e/BANNER_579213001452715.jpg" className="d-block w-100" style={{borderRadius: '2255px 5px 2255px 5px'}} alt="..." />
  </div>
